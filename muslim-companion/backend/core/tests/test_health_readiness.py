...
class TestReadinessProbe:
    ...
    def test_readiness_with_database_down(self, api_client, monkeypatch):
    ...
    def test_readiness_with_cache_down(self, api_client, monkeypatch):
    ...
    def test_readiness_with_celery_down(self, api_client, monkeypatch):
    ...
    def test_readiness_response_time_under_1000ms(self, api_client):
        """Test that readiness probe responds within reasonable time."""
        url = reverse("health-readiness")
        ...
        # Test environment may be slower due to Celery inspect calls
        # Production target is < 1000ms, but allow more in tests
        assert response_time_ms < 5000, f"Response time: {response_time_ms:.2f}ms"
