...
from backend.core.decorators import cache_response
from backend.core.decorators import warm_cache
from backend.core.health import check_cache_health
from backend.core.metrics import CacheMetrics
from backend.core.services import CacheManager
from backend.core.signals import invalidate_cache_by_key
from backend.core.signals import invalidate_cache_by_pattern
...
class TestGracefulDegradation:
    ...
    @patch("backend.core.services.cache_manager.cache")
...
class TestCacheHealth:
    ...
    @patch("backend.core.health.cache")
