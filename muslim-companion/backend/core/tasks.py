...
@shared_task(
    name="backend.core.warm_quran_cache",
    bind=True,
    max_retries=3,
...
@shared_task(name="backend.core.check_cache_health")
...
@shared_task(name="backend.core.log_cache_metrics")
...
@shared_task(
    name="backend.core.run_daily_backup",
    bind=True,
    max_retries=1,
...
@shared_task(
    name="backend.core.enforce_backup_retention_policy",
    bind=True,
)
