...
class Command(BaseCommand):
    ...
    def _warm_translation_cache(self, limit: int | None = None) -> int:
        ...
        try:
            # Import here to avoid errors if models don't exist yet
            from quran_backend.translation.models import (  # type: ignore[import-not-found]
                Translation,
            )
            from quran_backend.translation.serializers import (  # type: ignore[import-not-found]
